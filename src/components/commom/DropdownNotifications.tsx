function DropdownNotifications() {
    return (
        ...
        >
            <div
                className="block py-2 px-4 text-base font-medium text-center bg-primary-300 text-white dark:bg-primary-300 dark:text-white"
            >
                Notifications
            </div>
            <div>
                ...
                >
                    <div className="flex-shrink-0">
                        <img
                            ...
                            src="https://img.icons8.com/?size=100&id=AjTPlMclWxjF&format=png&color=000000"
                ...
                >
                    ...
                    <div className="pl-3 w-full">
                        ...
                        >
                            ...
                            <span className="font-medium text-primary-600 dark:text-primary-500"> @bonnie.green</span> what do you say?
                        </div>
                        <div
                            className="text-xs font-medium text-primary-600 dark:text-primary-500"
                        >
            ...
            <a
                href="#"
                className="block py-2 text-md font-medium text-center text-white bg-primary-300 hover:bg-primary-400 dark:bg-primary-300 dark:text-white dark:hover:underline"
            >
                <div className="inline-flex items-center">
                    <svg
                        aria-hidden="true"
                        className="mr-2 w-4 h-4 text-white dark:text-white"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                    >
