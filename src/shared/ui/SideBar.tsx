        ...
        >
            <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                ...
                <ul className="space-y-2">
                    ...
                    <li>
                        <Link
                            to={{ pathname: '/admin/management-user' }}
                            className="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <img
                                alt=""
                                className="w-5"
                                src={icAsset.people}
                            />
                            <span className="ml-3">Management Users</span>
                        </Link>
                    </li>
                    <li>
                        <button
                        ...
                        >
                            ...
                            <span className="flex-1 ml-3 text-left whitespace-nowrap">Shopping</span>
                            <svg
                                aria-hidden="true"
                                className="w-6 h-6"
                                fill="currentColor"
                ...
                >
                    <li>
                        <Link
                            ...
                            <span className="ml-3">API Docs</span>
                        </Link>
                    </li>
                </ul>
            </div>
